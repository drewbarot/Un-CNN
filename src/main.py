# -*- coding: utf-8 -*-
"""
Created on Sun Nov 25 01:44:44 2018
...
'''Label an image'''
def prediction(image_mod):    
    # Load the image file and convert it to a numpy array
    img = image.load_img(image_mod, target_size=(299, 299))
...
def modifier(image_mod):    
    ...
    while cost < 0.80:
        ...
        print("Model is changing the image. Checking gradient: {:.8}%".format(cost * 100))
